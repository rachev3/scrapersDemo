import type { CrawlingContext } from '@crawlee/src/crawlers/crawler_commons';
import type { KeyValueStore } from '@crawlee/src/storages';
import type { ErrnoException } from '@crawlee/src/crawlers/error_tracker';
