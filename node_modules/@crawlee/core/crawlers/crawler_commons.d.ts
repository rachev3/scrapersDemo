...
import type { Configuration } from '@crawlee/src/configuration';
import type { EnqueueLinksOptions } from '@crawlee/src/enqueue_links/enqueue_links';
import type { Log } from '@crawlee/src/log';
import type { ProxyInfo } from '@crawlee/src/proxy_configuration';
import type { Request, Source } from '@crawlee/src/request';
import type { Session } from '@crawlee/src/session_pool/session';
import type { Dataset, RecordOptions, RequestQueueOperationOptions } from '@crawlee/src/storages';
import { KeyValueStore } from '@crawlee/src/storages';
/** @internal */
