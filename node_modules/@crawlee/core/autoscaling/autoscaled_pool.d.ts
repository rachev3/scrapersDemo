...
import type { SnapshotterOptions } from '@crawlee/src/autoscaling/snapshotter';
import type { SystemInfo, SystemStatusOptions } from '@crawlee/src/autoscaling/system_status';
