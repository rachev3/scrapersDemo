...
import { Configuration } from '@crawlee/src/configuration';
import type { PersistenceOptions } from '@crawlee/src/crawlers/statistics';
import type { EventManager } from '@crawlee/src/events/event_manager';
import { KeyValueStore } from '@crawlee/src/storages/key_value_store';
import type { SessionOptions } from '@crawlee/src/session_pool/session';
import { Session } from '@crawlee/src/session_pool/session';
/**
...
// @ts-ignore optional peer dependency or compatibility with es2022
        sessions: import("@crawlee/src/session_pool/session").SessionState[];
    };
    /**
